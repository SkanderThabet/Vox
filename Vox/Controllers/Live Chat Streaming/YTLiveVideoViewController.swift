...
final class YTLiveVideoViewController: UIViewController {
    ...
    private lazy var chatViewController: UIViewController = {
        let chatController = YTLiveChatViewController.sharedInstance()
...
extension YTLiveVideoViewController {
    static func sharedInstance() -> YTLiveVideoViewController {
        let storyboard = UIStoryboard.init(name: "Main", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: "YTLiveVideoViewController") as! YTLiveVideoViewController
