...
extension YTLiveChatViewController {
    static func sharedInstance() -> YTLiveChatViewController {
        let storyboard = UIStoryboard.init(name: "Main", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: "YTLiveChatViewController") as! YTLiveChatViewController
