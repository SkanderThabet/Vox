...
final class VoxLiveVideoViewController: UIViewController {
    private let url =
    ...
    private lazy var chatViewController: UIViewController = {
        let chatController = VoxLiveVideoViewController()
...
extension VoxLiveVideoViewController {
    static func sharedInstance() -> VoxLiveVideoViewController {
        let storyboard = UIStoryboard.init(name: "Main", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: "VoxLiveVideoViewController") as! VoxLiveVideoViewController
